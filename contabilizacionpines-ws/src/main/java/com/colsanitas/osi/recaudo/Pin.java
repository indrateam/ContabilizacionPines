...
public class Pin implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -5800652203025310146L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/recaudo", "Pin", "ns7");

    /**
     * field for Pin
     */

    protected com.colsanitas.osi.recaudo.PinType localPin;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.recaudo.PinType
     */
    public com.colsanitas.osi.recaudo.PinType getPin() {
        return localPin;
    }
     ...
     * @param param Pin
     */
    public void setPin(final com.colsanitas.osi.recaudo.PinType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localPin.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localPin.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Pin parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/recaudo", "Pin").equals(reader
                                        .getName())) {

                            object.setPin(com.colsanitas.osi.recaudo.PinType.Factory.parse(reader));
