...
public class Concepto implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 4176830843892748775L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/recaudo", "concepto", "ns7");

    /**
     * field for Concepto
     */

    protected com.colsanitas.osi.recaudo.ConceptoType localConcepto;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.recaudo.ConceptoType
     */
    public com.colsanitas.osi.recaudo.ConceptoType getConcepto() {
     ...
     */
    public void setConcepto(final com.colsanitas.osi.recaudo.ConceptoType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localConcepto.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localConcepto.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Concepto parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Concepto object = new Concepto();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/recaudo", "concepto")
                                        .equals(reader.getName())) {

                            object.setConcepto(com.colsanitas.osi.recaudo.ConceptoType.Factory
                                    .parse(reader));
