...
/**
 * Tira_auditora bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class Tira_auditora implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -3987152170898910587L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/recaudo/TiraAuditora", "tira_auditora", "ns8");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localTira_auditora == null) {
            throw new org.apache.axis2.databinding.ADBException("tira_auditora cannot be null!");
        }
        localTira_auditora.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localTira_auditora.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Tira_auditora parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Tira_auditora object = new Tira_auditora();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        ...
                                        "tira_auditora").equals(reader.getName())) {
