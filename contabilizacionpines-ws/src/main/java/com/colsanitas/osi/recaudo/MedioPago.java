...
/**
 * MedioPago bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class MedioPago implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 1471354285794022914L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/recaudo", "medioPago", "ns7");

    /**
     * field for MedioPago
     */

    protected com.colsanitas.osi.recaudo.MedioPagoType localMedioPago;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.recaudo.MedioPagoType
     */
    public com.colsanitas.osi.recaudo.MedioPagoType getMedioPago() {
        return localMedioPago;
    }
     ...
     */
    public void setMedioPago(final com.colsanitas.osi.recaudo.MedioPagoType param) {

        this.localMedioPago = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localMedioPago == null) {
            throw new org.apache.axis2.databinding.ADBException("medioPago cannot be null!");
        }
        localMedioPago.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localMedioPago.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static MedioPago parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            MedioPago object = new MedioPago();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/recaudo", "medioPago")
                                        .equals(reader.getName())) {

                            object.setMedioPago(com.colsanitas.osi.recaudo.MedioPagoType.Factory
                                    .parse(reader));
