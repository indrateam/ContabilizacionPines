...
/**
 * ListaMediosPago_type0 bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class ListaMediosPago_type0 implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ListaMediosPago_type0
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -3035747952369119859L;
    /**
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ListaMediosPago_type0", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ListaMediosPago_type0", xmlWriter);
            }
            ...
            for (int i = 0; i < localMediosPago.length; i++) {
                if (localMediosPago[i] != null) {
                    localMediosPago[i].serialize(new javax.xml.namespace.QName(
                            "http://colsanitas.com/osi/srv/GestionDocEquivService", "mediosPago"),
                            xmlWriter);
                } else {

                    throw new org.apache.axis2.databinding.ADBException(
                            "mediosPago cannot be null!!");
    ...
    public static class Factory {
         ...
         */
        public static ListaMediosPago_type0 parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ListaMediosPago_type0 object = new ListaMediosPago_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ListaMediosPago_type0".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (ListaMediosPago_type0) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                                "http://colsanitas.com/osi/srv/GestionDocEquivService",
                                "mediosPago").equals(reader.getName())) {

                    // Process the array and step past its final element's end.
                    list1.add(com.colsanitas.osi.recaudo.MedioPagoType.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                    "http://colsanitas.com/osi/srv/GestionDocEquivService",
                                    "mediosPago").equals(reader.getName())) {
                                list1.add(com.colsanitas.osi.recaudo.MedioPagoType.Factory
                                        .parse(reader));
                    ...
                    object.setMediosPago((com.colsanitas.osi.recaudo.MedioPagoType[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.colsanitas.osi.recaudo.MedioPagoType.class, list1));
