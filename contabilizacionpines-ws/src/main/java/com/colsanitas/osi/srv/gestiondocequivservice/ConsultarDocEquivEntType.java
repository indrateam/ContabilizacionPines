...
/**
 * ConsultarDocEquivEntType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class ConsultarDocEquivEntType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = consultarDocEquivEntType
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 8648299662607602905L;
    /**
    ...
    /**
     * field for Num_transaccion_docEquiv
     */

    protected com.colsanitas.osi.recaudo.transaccion.NumeroTransaccionType localNum_transaccion_docEquiv;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.recaudo.transaccion.NumeroTransaccionType
     */
    public com.colsanitas.osi.recaudo.transaccion.NumeroTransaccionType getNum_transaccion_docEquiv() {
        return localNum_transaccion_docEquiv;
    }

    /**
     * Auto generated setter method
     * @param param Num_transaccion_docEquiv
     */
    public void setNum_transaccion_docEquiv(
            final com.colsanitas.osi.recaudo.transaccion.NumeroTransaccionType param) {

        this.localNum_transaccion_docEquiv = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultarDocEquivEntType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultarDocEquivEntType", xmlWriter);
            }
        ...
        if (localNum_transaccion_docEquiv == null) {
            throw new org.apache.axis2.databinding.ADBException(
                    "num_transaccion_docEquiv cannot be null!!");
        }
        localNum_transaccion_docEquiv.serialize(
                new javax.xml.namespace.QName(
                        "http://colsanitas.com/osi/srv/GestionDocEquivService",
                        "num_transaccion_docEquiv"), xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        elementList
                .add(new javax.xml.namespace.QName(
                        "http://colsanitas.com/osi/srv/GestionDocEquivService",
                        "num_transaccion_docEquiv"));

        if (localNum_transaccion_docEquiv == null) {
            throw new org.apache.axis2.databinding.ADBException(
                    "num_transaccion_docEquiv cannot be null!!");
        }
        elementList.add(localNum_transaccion_docEquiv);
    ...
    public static class Factory {
         ...
         */
        public static ConsultarDocEquivEntType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ConsultarDocEquivEntType object = new ConsultarDocEquivEntType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultarDocEquivEntType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (ConsultarDocEquivEntType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                                "http://colsanitas.com/osi/srv/GestionDocEquivService",
                                "num_transaccion_docEquiv").equals(reader.getName())) {

                    object.setNum_transaccion_docEquiv(com.colsanitas.osi.recaudo.transaccion.NumeroTransaccionType.Factory
                            .parse(reader));
