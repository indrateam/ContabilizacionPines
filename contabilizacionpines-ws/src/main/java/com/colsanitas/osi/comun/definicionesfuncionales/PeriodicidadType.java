...
/**
 * PeriodicidadType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class PeriodicidadType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = periodicidadType Namespace
     * URI = http://colsanitas.com/osi/comun/definicionesfuncionales Namespace Prefix = ns3
     */

    /**
                 * 
                 */
    private static final long serialVersionUID = 914604949714379979L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoPeriodType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoPeriodType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoPeriodType getCodigo() {
        return localCodigo;
    }
    ...
    public void setCodigo(
            final com.colsanitas.osi.comun.definicionesfuncionales.CodigoPeriodType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":periodicidadType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "periodicidadType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static PeriodicidadType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            PeriodicidadType object = new PeriodicidadType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"periodicidadType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (PeriodicidadType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoPeriodType.Factory
                            .parse(reader));
