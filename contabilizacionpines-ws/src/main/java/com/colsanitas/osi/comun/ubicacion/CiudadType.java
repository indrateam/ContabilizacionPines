...
/**
 * CiudadType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class CiudadType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ciudadType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 1335663379522999631L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.ubicacion.CodigoCiudadType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.CodigoCiudadType
     */
    public com.colsanitas.osi.comun.ubicacion.CodigoCiudadType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.ubicacion.CodigoCiudadType param) {
    ...
    protected com.colsanitas.osi.comun.ubicacion.DepartamentoType localDepartamento;
    ...
    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.DepartamentoType
     */
    public com.colsanitas.osi.comun.ubicacion.DepartamentoType getDepartamento() {
     ...
     */
    public void setDepartamento(final com.colsanitas.osi.comun.ubicacion.DepartamentoType param) {
    ...
    /**
     * field for CodigoLocalizacion
     */

    protected java.lang.String localCodigoLocalizacion;

    /*
     * This tracker boolean wil be used to detect whether the user called the set method for this
     * attribute. It will be used to determine whether to include this field in the serialized XML
     */
    protected boolean localCodigoLocalizacionTracker = false;

    public boolean isCodigoLocalizacionSpecified() {
        return localCodigoLocalizacionTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getCodigoLocalizacion() {
        return localCodigoLocalizacion;
    }

    /**
     * Auto generated setter method
     * @param param CodigoLocalizacion
     */
    public void setCodigoLocalizacion(final java.lang.String param) {
        localCodigoLocalizacionTracker = param != null;

        this.localCodigoLocalizacion = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ciudadType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ciudadType", xmlWriter);
            }
        ...
        if (localDepartamentoTracker) {
            ...
            localDepartamento.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "departamento"), xmlWriter);
        }
        if (localCodigoLocalizacionTracker) {
            namespace = "http://colsanitas.com/osi/comun/ubicacion";
            writeStartElement(null, namespace, "codigoLocalizacion", xmlWriter);

            if (localCodigoLocalizacion == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException(
                        "codigoLocalizacion cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localCodigoLocalizacion);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localDepartamentoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "departamento"));

            if (localDepartamento == null) {
                throw new org.apache.axis2.databinding.ADBException("departamento cannot be null!!");
            }
            elementList.add(localDepartamento);
        }
        if (localCodigoLocalizacionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "codigoLocalizacion"));

            if (localCodigoLocalizacion != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(localCodigoLocalizacion));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                        "codigoLocalizacion cannot be null!!");
            }
    ...
    public static class Factory {
         ...
         */
        public static CiudadType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CiudadType object = new CiudadType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ciudadType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (CiudadType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.ubicacion.CodigoCiudadType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    object.setDepartamento(com.colsanitas.osi.comun.ubicacion.DepartamentoType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigoLocalizacion(org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToString(content));
