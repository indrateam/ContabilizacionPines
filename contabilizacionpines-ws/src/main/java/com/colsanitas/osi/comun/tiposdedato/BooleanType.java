...
package com.colsanitas.osi.comun.tiposdedato;

/**
 * BooleanType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class BooleanType implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -919892418460234821L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/tiposdedato", "booleanType", "ns6");

    /**
     * field for BooleanType
     */

    protected java.lang.String localBooleanType;

    private static java.util.HashMap _table_ = new java.util.HashMap();

    // Constructor

    protected BooleanType(final java.lang.String value, final boolean isRegisterValue) {
        localBooleanType = value;
        if (isRegisterValue) {

            _table_.put(localBooleanType, this);
    ...
    public static final BooleanType value1 = new BooleanType(_value1, true);

    public static final BooleanType value2 = new BooleanType(_value2, true);

    public java.lang.String getValue() {
        return localBooleanType;
    }
    ...
    public java.lang.String toString() {
        ...
        return localBooleanType.toString();
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter,
                    "http://colsanitas.com/osi/comun/tiposdedato");
        ...
        if (localBooleanType == null) {

            throw new org.apache.axis2.databinding.ADBException("booleanType cannot be null !!");

        } else {

            xmlWriter.writeCharacters(localBooleanType);
    ...
    private static java.lang.String generatePrefix(final java.lang.String namespace) {
        if (namespace.equals("http://colsanitas.com/osi/comun/tiposdedato")) {
            return "ns6";
        }
        ...
        return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                new java.lang.Object[] {
                        ...
                        org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localBooleanType) }, null);
    ...
    public static class Factory {
        ...
        public static BooleanType fromValue(final java.lang.String value)
        ...
        public static BooleanType fromString(final java.lang.String value,
         ...
         */
        public static BooleanType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            BooleanType object = null;
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = BooleanType.Factory.fromString(content, namespaceuri);
                        } else {
                            // this seems to be not a qname send and empty namespace incase of it is
                            // check is done in fromString method
                            object = BooleanType.Factory.fromString(content, "");
                        }
