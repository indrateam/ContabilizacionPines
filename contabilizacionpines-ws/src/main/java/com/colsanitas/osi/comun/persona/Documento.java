...
/**
 * Documento bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class Documento implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 10292742255115553L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "Documento", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localDocumento.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localDocumento.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Documento parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/persona", "Documento")
