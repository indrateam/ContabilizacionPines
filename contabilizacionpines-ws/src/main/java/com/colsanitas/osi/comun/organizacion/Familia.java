...
public class Familia implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -5278657276728736910L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "Familia", "ns2");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localFamilia.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localFamilia.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Familia parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Familia object = new Familia();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                            ...
                            object.setFamilia(com.colsanitas.osi.comun.organizacion.FamiliaType.Factory
                                    .parse(reader));
