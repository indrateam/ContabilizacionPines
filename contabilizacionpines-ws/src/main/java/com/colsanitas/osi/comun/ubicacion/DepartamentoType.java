...
/**
 * DepartamentoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class DepartamentoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = departamentoType Namespace
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 625410691816193101L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.ubicacion.CodigoDepartamentoType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.CodigoDepartamentoType
     */
    public com.colsanitas.osi.comun.ubicacion.CodigoDepartamentoType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.ubicacion.CodigoDepartamentoType param) {
    ...
    protected com.colsanitas.osi.comun.ubicacion.RegionType localRegion;
    ...
    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.RegionType
     */
    public com.colsanitas.osi.comun.ubicacion.RegionType getRegion() {
        return localRegion;
    }
     ...
     * @param param Region
     */
    public void setRegion(final com.colsanitas.osi.comun.ubicacion.RegionType param) {
    ...
    protected com.colsanitas.osi.comun.ubicacion.PaisType localPais;
    ...
    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.PaisType
     */
    public com.colsanitas.osi.comun.ubicacion.PaisType getPais() {
        return localPais;
    }
     ...
     * @param param Pais
     */
    public void setPais(final com.colsanitas.osi.comun.ubicacion.PaisType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":departamentoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "departamentoType", xmlWriter);
            }
        ...
        if (localRegionTracker) {
            ...
            localRegion.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "region"), xmlWriter);
        }
        if (localPaisTracker) {
            if (localPais == null) {
                throw new org.apache.axis2.databinding.ADBException("pais cannot be null!!");
            }
            localPais.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "pais"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localRegionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "region"));
        ...
        if (localPaisTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "pais"));
    ...
    public static class Factory {
         ...
         */
        public static DepartamentoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            DepartamentoType object = new DepartamentoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"departamentoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (DepartamentoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.ubicacion.CodigoDepartamentoType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    object.setRegion(com.colsanitas.osi.comun.ubicacion.RegionType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                                "http://colsanitas.com/osi/comun/ubicacion", "pais").equals(reader
                                .getName())) {

                    object.setPais(com.colsanitas.osi.comun.ubicacion.PaisType.Factory
                            .parse(reader));
