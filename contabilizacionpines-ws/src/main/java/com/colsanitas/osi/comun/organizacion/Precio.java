...
public class Precio implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 8174110815617720616L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "Precio", "ns2");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localPrecio.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localPrecio.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Precio parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Precio object = new Precio();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/organizacion", "Precio")
