...
/**
 * ZonaLocalidadType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class ZonaLocalidadType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = zonaLocalidadType Namespace
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -3339994144137704296L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.ubicacion.CodigoZonaLocalidadType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.CodigoZonaLocalidadType
     */
    public com.colsanitas.osi.comun.ubicacion.CodigoZonaLocalidadType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.ubicacion.CodigoZonaLocalidadType param) {
    ...
    protected com.colsanitas.osi.comun.ubicacion.ViaType localZona;
     ...
     */
    public com.colsanitas.osi.comun.ubicacion.ViaType getZona() {
        return localZona;
    }
     ...
     * @param param Zona
     */
    public void setZona(final com.colsanitas.osi.comun.ubicacion.ViaType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":zonaLocalidadType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "zonaLocalidadType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static ZonaLocalidadType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ZonaLocalidadType object = new ZonaLocalidadType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"zonaLocalidadType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (ZonaLocalidadType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.ubicacion.CodigoZonaLocalidadType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    object.setZona(com.colsanitas.osi.comun.ubicacion.ViaType.Factory.parse(reader));
