...
/**
 * AtributoContratoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class AtributoContratoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = atributoContratoType
     * Namespace URI = http://colsanitas.com/osi/comun/organizacion Namespace Prefix = ns2
     */

    /**
                 * 
                 */
    private static final long serialVersionUID = -1121878454497929983L;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":atributoContratoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "atributoContratoType", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localValorTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "valor"));
    ...
    public static class Factory {
         ...
         */
        public static AtributoContratoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            AtributoContratoType object = new AtributoContratoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"atributoContratoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (AtributoContratoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
