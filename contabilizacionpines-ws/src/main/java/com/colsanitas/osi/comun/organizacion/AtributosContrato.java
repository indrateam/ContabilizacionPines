...
/**
 * AtributosContrato bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class AtributosContrato implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -303585090272914494L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "AtributosContrato", "ns2");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localAtributosContrato == null) {
            throw new org.apache.axis2.databinding.ADBException("AtributosContrato cannot be null!");
        }
        localAtributosContrato.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localAtributosContrato.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static AtributosContrato parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            AtributosContrato object = new AtributosContrato();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        ...
                                        "AtributosContrato").equals(reader.getName())) {
