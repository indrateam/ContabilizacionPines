...
public class Apellido implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 8435940199014810927L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "Apellido", "ns5");

    /**
     * field for Apellido
     */

    protected com.colsanitas.osi.comun.persona.ApellidoType localApellido;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.persona.ApellidoType
     */
    public com.colsanitas.osi.comun.persona.ApellidoType getApellido() {
     ...
     */
    public void setApellido(final com.colsanitas.osi.comun.persona.ApellidoType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localApellido.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localApellido.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Apellido parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Apellido object = new Apellido();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/persona", "Apellido")
                                        .equals(reader.getName())) {

                            object.setApellido(com.colsanitas.osi.comun.persona.ApellidoType.Factory
                                    .parse(reader));
