...
public class Telefono implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -1952947232122311938L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/ubicacion", "Telefono", "ns4");

    /**
     * field for Telefono
     */

    protected com.colsanitas.osi.comun.ubicacion.TelefonoType localTelefono;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.TelefonoType
     */
    public com.colsanitas.osi.comun.ubicacion.TelefonoType getTelefono() {
     ...
     */
    public void setTelefono(final com.colsanitas.osi.comun.ubicacion.TelefonoType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTelefono.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localTelefono.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Telefono parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Telefono object = new Telefono();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/ubicacion", "Telefono")
                                        .equals(reader.getName())) {

                            object.setTelefono(com.colsanitas.osi.comun.ubicacion.TelefonoType.Factory
                                    .parse(reader));
