...
/**
 * RegionType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class RegionType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = regionType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 5483057793117999617L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.ubicacion.CodigoRegionType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.CodigoRegionType
     */
    public com.colsanitas.osi.comun.ubicacion.CodigoRegionType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.ubicacion.CodigoRegionType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":regionType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "regionType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static RegionType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RegionType object = new RegionType();
            ...
            try {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"regionType".equals(type)) {
                            ...
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (RegionType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.ubicacion.CodigoRegionType.Factory
                            .parse(reader));
