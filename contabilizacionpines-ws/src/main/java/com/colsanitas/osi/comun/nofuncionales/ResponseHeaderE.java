...
/**
 * ResponseHeaderE bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class ResponseHeaderE implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -6493772140895814358L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/nofuncionales", "ResponseHeader", "ns1");

    /**
     * field for ResponseHeader
     */

    protected com.colsanitas.osi.comun.nofuncionales.ResponseHeader localResponseHeader;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.nofuncionales.ResponseHeader
     */
    public com.colsanitas.osi.comun.nofuncionales.ResponseHeader getResponseHeader() {
     ...
     */
    public void setResponseHeader(final com.colsanitas.osi.comun.nofuncionales.ResponseHeader param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localResponseHeader.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localResponseHeader.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static ResponseHeaderE parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ResponseHeaderE object = new ResponseHeaderE();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        ...
                                        "ResponseHeader").equals(reader.getName())) {

                            object.setResponseHeader(com.colsanitas.osi.comun.nofuncionales.ResponseHeader.Factory
                                    .parse(reader));
