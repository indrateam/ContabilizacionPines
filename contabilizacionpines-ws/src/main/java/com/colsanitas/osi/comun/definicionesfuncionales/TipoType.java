...
public class TipoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = tipoType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -7984571445085051454L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoTipoType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoTipoType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoTipoType getCodigo() {
        return localCodigo;
    }
    ...
    public void setCodigo(
            final com.colsanitas.osi.comun.definicionesfuncionales.CodigoTipoType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":tipoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "tipoType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static TipoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            TipoType object = new TipoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tipoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (TipoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoTipoType.Factory
                            .parse(reader));
