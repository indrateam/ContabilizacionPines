...
/**
 * Identificacion bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class Identificacion implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 6599295372621850327L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "Identificacion", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localIdentificacion.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localIdentificacion.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Identificacion parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Identificacion object = new Identificacion();
