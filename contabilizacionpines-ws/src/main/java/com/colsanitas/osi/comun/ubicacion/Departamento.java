...
/**
 * Departamento bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class Departamento implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 1302854091047821814L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/ubicacion", "Departamento", "ns4");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localDepartamento.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localDepartamento.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Departamento parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Departamento object = new Departamento();
