...
public class Usuario implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -682131100656108430L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "Usuario", "ns2");

    /**
     * field for Usuario
     */

    protected com.colsanitas.osi.comun.organizacion.UsuarioType localUsuario;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.organizacion.UsuarioType
     */
    public com.colsanitas.osi.comun.organizacion.UsuarioType getUsuario() {
        return localUsuario;
    }
     ...
     * @param param Usuario
     */
    public void setUsuario(final com.colsanitas.osi.comun.organizacion.UsuarioType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localUsuario.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localUsuario.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Usuario parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/organizacion", "Usuario")
                                        .equals(reader.getName())) {

                            object.setUsuario(com.colsanitas.osi.comun.organizacion.UsuarioType.Factory
                                    .parse(reader));
