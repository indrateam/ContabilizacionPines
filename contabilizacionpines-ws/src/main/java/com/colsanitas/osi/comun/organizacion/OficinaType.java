...
/**
 * OficinaType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class OficinaType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = oficinaType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 6008034736567536736L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.organizacion.CodigoOficinaType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.organizacion.CodigoOficinaType
     */
    public com.colsanitas.osi.comun.organizacion.CodigoOficinaType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.organizacion.CodigoOficinaType param) {
    ...
    protected com.colsanitas.osi.comun.ubicacion.DireccionType localUbicacion;
    ...
    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.DireccionType
     */
    public com.colsanitas.osi.comun.ubicacion.DireccionType getUbicacion() {
     ...
     */
    public void setUbicacion(final com.colsanitas.osi.comun.ubicacion.DireccionType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":oficinaType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "oficinaType", xmlWriter);
            }
        ...
        if (localUbicacionTracker) {
            ...
            localUbicacion.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "ubicacion"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localUbicacionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "ubicacion"));

            if (localUbicacion == null) {
                throw new org.apache.axis2.databinding.ADBException("ubicacion cannot be null!!");
            }
            elementList.add(localUbicacion);
        }
    ...
    public static class Factory {
         ...
         */
        public static OficinaType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            OficinaType object = new OficinaType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"oficinaType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (OficinaType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.organizacion.CodigoOficinaType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    object.setUbicacion(com.colsanitas.osi.comun.ubicacion.DireccionType.Factory
                            .parse(reader));
