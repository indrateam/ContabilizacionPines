...
/**
 * Direccion bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class Direccion implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 190999850942775526L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/ubicacion", "Direccion", "ns4");

    /**
     * field for Direccion
     */

    protected com.colsanitas.osi.comun.ubicacion.DireccionType localDireccion;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.DireccionType
     */
    public com.colsanitas.osi.comun.ubicacion.DireccionType getDireccion() {
     ...
     */
    public void setDireccion(final com.colsanitas.osi.comun.ubicacion.DireccionType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localDireccion.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localDireccion.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Direccion parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/ubicacion", "Direccion")
                                        .equals(reader.getName())) {

                            object.setDireccion(com.colsanitas.osi.comun.ubicacion.DireccionType.Factory
                                    .parse(reader));
