...
/**
 * EstadoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class EstadoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = estadoType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -2530522698929848480L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoEstadoType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoEstadoType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoEstadoType getCodigo() {
        return localCodigo;
    }
    ...
    public void setCodigo(
            final com.colsanitas.osi.comun.definicionesfuncionales.CodigoEstadoType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":estadoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "estadoType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static EstadoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            EstadoType object = new EstadoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"estadoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (EstadoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoEstadoType.Factory
                            .parse(reader));
