...
/**
 * CompaniaType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class CompaniaType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = companiaType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 774619827050267549L;

    /**
     * field for CodCompania
     */

    protected com.colsanitas.osi.comun.organizacion.CodigoCiaType localCodCompania;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.organizacion.CodigoCiaType
     */
    public com.colsanitas.osi.comun.organizacion.CodigoCiaType getCodCompania() {
        return localCodCompania;
    }

    /**
     * Auto generated setter method
     * @param param CodCompania
     */
    public void setCodCompania(final com.colsanitas.osi.comun.organizacion.CodigoCiaType param) {

        this.localCodCompania = param;

    }

    /**
     * field for DesCompania
     */

    protected java.lang.String localDesCompania;

    /*
     * This tracker boolean wil be used to detect whether the user called the set method for this
     * attribute. It will be used to determine whether to include this field in the serialized XML
     */
    protected boolean localDesCompaniaTracker = false;

    public boolean isDesCompaniaSpecified() {
        return localDesCompaniaTracker;
    }
     ...
     */
    public java.lang.String getDesCompania() {
        return localDesCompania;
    }

    /**
     * Auto generated setter method
     * @param param DesCompania
     */
    public void setDesCompania(final java.lang.String param) {
        localDesCompaniaTracker = param != null;

        this.localDesCompania = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":companiaType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "companiaType", xmlWriter);
            }

        }

        if (localCodCompania == null) {
            throw new org.apache.axis2.databinding.ADBException("codCompania cannot be null!!");
        }
        localCodCompania.serialize(new javax.xml.namespace.QName(
                "http://colsanitas.com/osi/comun/organizacion", "codCompania"), xmlWriter);
        if (localDesCompaniaTracker) {
            namespace = "http://colsanitas.com/osi/comun/organizacion";
            writeStartElement(null, namespace, "desCompania", xmlWriter);

            if (localDesCompania == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("desCompania cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localDesCompania);
        ...
        if (localIdentificacionTracker) {
            ...
            localIdentificacion.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "identificacion"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://colsanitas.com/osi/comun/organizacion", "codCompania"));

        if (localCodCompania == null) {
            throw new org.apache.axis2.databinding.ADBException("codCompania cannot be null!!");
        }
        elementList.add(localCodCompania);
        if (localDesCompaniaTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "desCompania"));

            if (localDesCompania != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(localDesCompania));
            } else {
                throw new org.apache.axis2.databinding.ADBException("desCompania cannot be null!!");
            }
        }
        ...
        if (localIdentificacionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "identificacion"));
    ...
    public static class Factory {
         ...
         */
        public static CompaniaType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CompaniaType object = new CompaniaType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"companiaType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (CompaniaType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodCompania(com.colsanitas.osi.comun.organizacion.CodigoCiaType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: "
                                + "desCompania" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setDesCompania(org.apache.axis2.databinding.utils.ConverterUtil
