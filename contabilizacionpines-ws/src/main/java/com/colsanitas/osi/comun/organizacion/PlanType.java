...
public class PlanType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = planType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -2764923760911432778L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.organizacion.CodigoPlanType localCodigo;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.organizacion.CodigoPlanType
     */
    public com.colsanitas.osi.comun.organizacion.CodigoPlanType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.organizacion.CodigoPlanType param) {
    ...
    /**
     * field for FechaUltimaActualizacion
     */

    protected java.lang.String localFechaUltimaActualizacion;

    /*
     * This tracker boolean wil be used to detect whether the user called the set method for this
     * attribute. It will be used to determine whether to include this field in the serialized XML
     */
    protected boolean localFechaUltimaActualizacionTracker = false;

    public boolean isFechaUltimaActualizacionSpecified() {
        return localFechaUltimaActualizacionTracker;
    }
    ...
    public java.lang.String getFechaUltimaActualizacion() {
        return localFechaUltimaActualizacion;
    }

    /**
     * Auto generated setter method
     * @param param FechaUltimaActualizacion
     */
    public void setFechaUltimaActualizacion(final java.lang.String param) {
        localFechaUltimaActualizacionTracker = param != null;

        this.localFechaUltimaActualizacion = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":planType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "planType", xmlWriter);
            }
        ...
        localCodigo.serialize(new javax.xml.namespace.QName(
                "http://colsanitas.com/osi/comun/organizacion", "codigo"), xmlWriter);
        ...
        if (localFechaUltimaActualizacionTracker) {
            namespace = "http://colsanitas.com/osi/comun/organizacion";
            writeStartElement(null, namespace, "fechaUltimaActualizacion", xmlWriter);

            if (localFechaUltimaActualizacion == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException(
                        "fechaUltimaActualizacion cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localFechaUltimaActualizacion);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://colsanitas.com/osi/comun/organizacion", "codigo"));
        ...
        if (localDescripcionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "descripcion"));
        ...
        if (localFechaUltimaActualizacionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/organizacion", "fechaUltimaActualizacion"));

            if (localFechaUltimaActualizacion != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(localFechaUltimaActualizacion));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                        "fechaUltimaActualizacion cannot be null!!");
            }
    ...
    public static class Factory {
         ...
         */
        public static PlanType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            PlanType object = new PlanType();
            ...
            try {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"planType".equals(type)) {
                            ...
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (PlanType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.organizacion.CodigoPlanType.Factory
                            .parse(reader));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                                "http://colsanitas.com/osi/comun/organizacion",
                                "fechaUltimaActualizacion").equals(reader.getName())) {
                    ...
                    object.setFechaUltimaActualizacion(org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToString(content));
