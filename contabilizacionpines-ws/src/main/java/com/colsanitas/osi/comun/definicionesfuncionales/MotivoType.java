...
/**
 * MotivoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class MotivoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = motivoType Namespace URI =
     * http://colsanitas.com/osi/comun/definicionesfuncionales Namespace Prefix = ns3
     */

    /**
                 * 
                 */
    private static final long serialVersionUID = -2186842192551675379L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoMotivoType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoMotivoType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoMotivoType getCodigo() {
        return localCodigo;
    }
    ...
    public void setCodigo(
            final com.colsanitas.osi.comun.definicionesfuncionales.CodigoMotivoType param) {
     ...
     * @param param Estado
     */
    public void setEstado(final java.lang.String param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":motivoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "motivoType", xmlWriter);
            }
        ...
        if (localCodigoTracker) {
            ...
            localCodigo
                    .serialize(new javax.xml.namespace.QName(
                            "http://colsanitas.com/osi/comun/definicionesfuncionales", "codigo"),
                            xmlWriter);
        }
        if (localDescripcionTracker) {
            namespace = "http://colsanitas.com/osi/comun/definicionesfuncionales";
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localDescripcionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/definicionesfuncionales", "descripcion"));
        ...
        if (localEstadoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/definicionesfuncionales", "estado"));
    ...
    public static class Factory {
         ...
         */
        public static MotivoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            MotivoType object = new MotivoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"motivoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (MotivoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoMotivoType.Factory
                            .parse(reader));
