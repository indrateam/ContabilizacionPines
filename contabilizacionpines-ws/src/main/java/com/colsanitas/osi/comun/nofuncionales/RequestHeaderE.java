...
/**
 * RequestHeaderE bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class RequestHeaderE implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 652623897261774712L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/nofuncionales", "RequestHeader", "ns1");

    /**
     * field for RequestHeader
     */

    protected com.colsanitas.osi.comun.nofuncionales.RequestHeader localRequestHeader;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.nofuncionales.RequestHeader
     */
    public com.colsanitas.osi.comun.nofuncionales.RequestHeader getRequestHeader() {
     ...
     */
    public void setRequestHeader(final com.colsanitas.osi.comun.nofuncionales.RequestHeader param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localRequestHeader.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localRequestHeader.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static RequestHeaderE parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RequestHeaderE object = new RequestHeaderE();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                            ...
                            object.setRequestHeader(com.colsanitas.osi.comun.nofuncionales.RequestHeader.Factory
                                    .parse(reader));
