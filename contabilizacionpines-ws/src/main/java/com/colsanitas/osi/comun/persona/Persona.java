...
public class Persona implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 1253997153116903807L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "Persona", "ns5");

    /**
     * field for Persona
     */

    protected com.colsanitas.osi.comun.persona.PersonaType localPersona;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.persona.PersonaType
     */
    public com.colsanitas.osi.comun.persona.PersonaType getPersona() {
        return localPersona;
    }
     ...
     * @param param Persona
     */
    public void setPersona(final com.colsanitas.osi.comun.persona.PersonaType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localPersona.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localPersona.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Persona parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/persona", "Persona")
                                        .equals(reader.getName())) {

                            object.setPersona(com.colsanitas.osi.comun.persona.PersonaType.Factory
                                    .parse(reader));
