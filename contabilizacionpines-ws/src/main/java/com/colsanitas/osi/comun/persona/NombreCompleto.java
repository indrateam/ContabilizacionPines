...
/**
 * NombreCompleto bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class NombreCompleto implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 5542420825270892461L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "NombreCompleto", "ns5");

    /**
     * field for NombreCompleto
     */

    protected com.colsanitas.osi.comun.persona.NombreCompletoType localNombreCompleto;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.persona.NombreCompletoType
     */
    public com.colsanitas.osi.comun.persona.NombreCompletoType getNombreCompleto() {
     ...
     */
    public void setNombreCompleto(final com.colsanitas.osi.comun.persona.NombreCompletoType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localNombreCompleto.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localNombreCompleto.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static NombreCompleto parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            NombreCompleto object = new NombreCompleto();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/persona", "NombreCompleto")
                                        .equals(reader.getName())) {

                            object.setNombreCompleto(com.colsanitas.osi.comun.persona.NombreCompletoType.Factory
                                    .parse(reader));
