...
/**
 * CelularType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class CelularType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = celularType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -2816561744698008015L;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":celularType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "celularType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static CelularType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CelularType object = new CelularType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"celularType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (CelularType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
