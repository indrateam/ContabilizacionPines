...
public class Nombre implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = -5356260747325682815L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "Nombre", "ns5");

    /**
     * field for Nombre
     */

    protected com.colsanitas.osi.comun.persona.NombreType localNombre;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.persona.NombreType
     */
    public com.colsanitas.osi.comun.persona.NombreType getNombre() {
        return localNombre;
    }
     ...
     * @param param Nombre
     */
    public void setNombre(final com.colsanitas.osi.comun.persona.NombreType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localNombre.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localNombre.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Nombre parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Nombre object = new Nombre();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                            ...
                            object.setNombre(com.colsanitas.osi.comun.persona.NombreType.Factory
                                    .parse(reader));
