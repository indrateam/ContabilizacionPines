...
/**
 * TipoDocumento bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class TipoDocumento implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 2123333995629773009L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/persona", "TipoDocumento", "ns5");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localTipoDocumento.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localTipoDocumento.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static TipoDocumento parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            TipoDocumento object = new TipoDocumento();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/persona", "TipoDocumento")
