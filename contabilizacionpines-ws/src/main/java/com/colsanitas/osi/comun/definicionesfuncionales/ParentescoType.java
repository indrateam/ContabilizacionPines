...
/**
 * ParentescoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class ParentescoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = parentescoType Namespace URI
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -7517274285766527349L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoParentescoType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoParentescoType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoParentescoType getCodigo() {
        return localCodigo;
    }
    ...
    public void setCodigo(
            final com.colsanitas.osi.comun.definicionesfuncionales.CodigoParentescoType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":parentescoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "parentescoType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static ParentescoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ParentescoType object = new ParentescoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"parentescoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (ParentescoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoParentescoType.Factory
                            .parse(reader));
