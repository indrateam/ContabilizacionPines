...
/**
 * AuthenticationHeader bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class AuthenticationHeader implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = AuthenticationHeader
     * Namespace URI = http://colsanitas.com/osi/comun/nofuncionales Namespace Prefix = ns1
     */

    /**
                 * 
                 */
    private static final long serialVersionUID = 5710617744275201727L;
    ...
    protected java.lang.String localUserToken;
    ...
    public boolean isUserTokenSpecified() {
        return localUserTokenTracker;
    }
     ...
     */
    public void setUserToken(final java.lang.String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AuthenticationHeader", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localUserTokenTracker) {
            namespace = "http://colsanitas.com/osi/comun/nofuncionales";
            writeStartElement(null, namespace, "userToken", xmlWriter);

            if (localUserToken == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("userToken cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localUserToken);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localUserNameTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/nofuncionales", "userName"));
        ...
        if (localUserTokenTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/nofuncionales", "userToken"));

            if (localUserToken != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(localUserToken));
            } else {
                throw new org.apache.axis2.databinding.ADBException("userToken cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AuthenticationHeader parse(final javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuthenticationHeader".equals(type)) {
                            ...
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (AuthenticationHeader) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setUserToken(org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToString(content));
