...
/**
 * CanalType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class CanalType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = canalType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -6116534477180868554L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.organizacion.CodigoCanalType localCodigo;
     ...
     */
    public com.colsanitas.osi.comun.organizacion.CodigoCanalType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.organizacion.CodigoCanalType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":canalType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "canalType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static CanalType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CanalType object = new CanalType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"canalType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (CanalType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.organizacion.CodigoCanalType.Factory
                            .parse(reader));
