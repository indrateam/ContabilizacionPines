...
/**
 * TelefonoType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class TelefonoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = telefonoType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 2278528499688446642L;
     ...
     * @param param Ext
     */
    public void setExt(final java.lang.String param) {
    ...
    /**
     * field for Indicativo
     */

    protected com.colsanitas.osi.comun.ubicacion.IndicativoType localIndicativo;

    /*
     * This tracker boolean wil be used to detect whether the user called the set method for this
     * attribute. It will be used to determine whether to include this field in the serialized XML
     */
    protected boolean localIndicativoTracker = false;

    public boolean isIndicativoSpecified() {
        return localIndicativoTracker;
    }

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.ubicacion.IndicativoType
     */
    public com.colsanitas.osi.comun.ubicacion.IndicativoType getIndicativo() {
        return localIndicativo;
    }

    /**
     * Auto generated setter method
     * @param param Indicativo
     */
    public void setIndicativo(final com.colsanitas.osi.comun.ubicacion.IndicativoType param) {
        localIndicativoTracker = param != null;

        this.localIndicativo = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":telefonoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "telefonoType", xmlWriter);
            }
        ...
        if (localIndicativoTracker) {
            if (localIndicativo == null) {
                throw new org.apache.axis2.databinding.ADBException("indicativo cannot be null!!");
            }
            localIndicativo.serialize(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "indicativo"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localExtTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "ext"));
        ...
        if (localIndicativoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/ubicacion", "indicativo"));

            if (localIndicativo == null) {
                throw new org.apache.axis2.databinding.ADBException("indicativo cannot be null!!");
            }
            elementList.add(localIndicativo);
        }
    ...
    public static class Factory {
         ...
         */
        public static TelefonoType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            TelefonoType object = new TelefonoType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"telefonoType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (TelefonoType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                                "http://colsanitas.com/osi/comun/ubicacion", "ext").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue(
                            "http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "ext"
                                + "  cannot be null");
                    }
                ...
                if (reader.isStartElement()
                    ...
                    object.setIndicativo(com.colsanitas.osi.comun.ubicacion.IndicativoType.Factory
                            .parse(reader));
