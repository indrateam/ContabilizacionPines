...
public class EpsType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = epsType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = -2600818019375946474L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoEpsType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoEpsType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoEpsType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.definicionesfuncionales.CodigoEpsType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":epsType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "epsType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static EpsType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            EpsType object = new EpsType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"epsType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (EpsType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoEpsType.Factory
                            .parse(reader));
