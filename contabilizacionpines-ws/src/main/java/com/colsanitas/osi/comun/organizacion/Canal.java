...
public class Canal implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 2196691882236400987L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "Canal", "ns2");

    /**
     * field for Canal
     */

    protected com.colsanitas.osi.comun.organizacion.CanalType localCanal;

    /**
     * Auto generated getter method
     * @return com.colsanitas.osi.comun.organizacion.CanalType
     */
    public com.colsanitas.osi.comun.organizacion.CanalType getCanal() {
        return localCanal;
    }
     ...
     * @param param Canal
     */
    public void setCanal(final com.colsanitas.osi.comun.organizacion.CanalType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localCanal.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localCanal.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Canal parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/organizacion", "Canal")
                                        .equals(reader.getName())) {

                            object.setCanal(com.colsanitas.osi.comun.organizacion.CanalType.Factory
                                    .parse(reader));
