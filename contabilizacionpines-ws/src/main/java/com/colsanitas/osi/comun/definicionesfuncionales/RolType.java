...
public class RolType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = rolType Namespace URI =
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 9126638112792115882L;

    /**
     * field for Codigo
     */

    protected com.colsanitas.osi.comun.definicionesfuncionales.CodigoRolType localCodigo;
     ...
     * @return com.colsanitas.osi.comun.definicionesfuncionales.CodigoRolType
     */
    public com.colsanitas.osi.comun.definicionesfuncionales.CodigoRolType getCodigo() {
        return localCodigo;
    }
     ...
     * @param param Codigo
     */
    public void setCodigo(final com.colsanitas.osi.comun.definicionesfuncionales.CodigoRolType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":rolType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "rolType", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static RolType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RolType object = new RolType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rolType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (RolType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setCodigo(com.colsanitas.osi.comun.definicionesfuncionales.CodigoRolType.Factory
                            .parse(reader));
