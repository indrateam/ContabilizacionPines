...
/**
 * AtributoPersonaType bean class
 */
@SuppressWarnings({"unchecked","unused","rawtypes"})
public class AtributoPersonaType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = atributoPersonaType
     * Namespace URI = http://colsanitas.com/osi/comun/persona Namespace Prefix = ns5
     */

    /**
                 * 
                 */
    private static final long serialVersionUID = 7106749015946221143L;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":atributoPersonaType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "atributoPersonaType", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (localCodigoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/persona", "codigo"));
        ...
        if (localDescripcionTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/persona", "descripcion"));
        ...
        if (localTipoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/persona", "tipo"));
        ...
        if (localValorTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://colsanitas.com/osi/comun/persona", "valor"));
    ...
    public static class Factory {
         ...
         */
        public static AtributoPersonaType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            AtributoPersonaType object = new AtributoPersonaType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"atributoPersonaType".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(
                                    nsPrefix);
                            return (AtributoPersonaType) com.colsanitas.gestiondocumentoequivalente.ExtensionMapper
