...
public class Ciudad implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 7179020183423087968L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/ubicacion", "Ciudad", "ns4");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localCiudad.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localCiudad.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Ciudad parse(final javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/ubicacion", "Ciudad")
