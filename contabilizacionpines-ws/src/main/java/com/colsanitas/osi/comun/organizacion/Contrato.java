...
public class Contrato implements org.apache.axis2.databinding.ADBBean {

    /**
                 * 
                 */
    private static final long serialVersionUID = 132337791960449635L;

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://colsanitas.com/osi/comun/organizacion", "Contrato", "ns2");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        localContrato.serialize(MY_QNAME, xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        // We can safely assume an element has only one type associated with it
        return localContrato.getPullParser(MY_QNAME);
    ...
    public static class Factory {
         ...
         */
        public static Contrato parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Contrato object = new Contrato();
                    ...
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                                && new javax.xml.namespace.QName(
                                        "http://colsanitas.com/osi/comun/organizacion", "Contrato")
